...
const PlayColumn = ({
  ...
  const [showPlayerRenameModal, setShowPlayerRenameModal] = React.useState(
    false
  );
  ...
  async function removePlayer(player_id) {
    try {
      ...
      alert(
        'Sorry, there was an error removing that player from the game: ',
        error
      );
    }
  }
  ...
  async function removeRule(rule) {
    try {
      ...
      alert(
        'Sorry, there was an error removing that rule from the game: ',
        error
      );
    }
  }
    ...
    <>
      ...
      >
        ...
        >
          <FontAwesomeIcon
            icon={faTimes}
            style={{ fontSize: '3.5rem', color: 'var(--color-blue' }}
          />
        </div>
        <div>
              ...
              return (
                <div className={classes.player} key={index}>
                  <p
                    ...
                    onClick={handleTogglePlayerAdmin}
                  >
                    {player.player_name}
                    {player.player_isOffline && (
                      <FontAwesomeIcon
                        style={{ color: '#aaa', fontSize: '1.4rem' }}
                        className={classes.playerIcon}
                        icon={faUserSlash}
                      />
                    )}
                    {player.player_isQmaster && (
                      <FontAwesomeIcon
                        className={classes.playerIcon}
                        icon={faQuestionCircle}
                      />
                    )}
                    {player.player_isTmaster && (
                      <FontAwesomeIcon
                        className={classes.playerIcon}
                        icon={faThumbsUp}
                      />
                  ...
                  <div className={classes.playerAdminRow}>
                    ...
                    <button
                      ...
                      onClick={() =>
                        removePlayerModal(player.player_id, player.player_name)
                      }
                    >
        ...
        <div className={classes.gameIdWrapper}>
          ...
          <p
            className={classes.gameIdUrl}
          >{`waterfall.beer/join/${gameStatus.shortId}`}</p>
          <div className={classes.fbLikeMobile}>
            <Like
